...
export const REVIEWS_DATA: ReviewItem[] = [
  {
    id: 1,
    quote:
      "their services for signing and logo and I must their work ressive, with attention. Most imp with these guys d P like orking as a sinc objective, they ta multiple iteration they seems to at time re more en positively. I high designing",
    extendedQuote:
      "their services for signing and logo and I must say their work is responsive, with immense attention to detail. Most importantly with these guys, working as a single objective, they tackle multiple iterations with passionate energy.",
    author: "Sarah Jenkins",
    title: "Product Lead, VibeUI",
    avatarLabel: "150×150",
    style: "light",
    tilt: -6,
  },
  ...
  },
  {
    id: 3,
    quote:
      "“Superb Designs and Good service I am fully satisfied all designs of DreamHii Must visit to dreamhii.”",
    extendedQuote:
      "“Superb Designs and Good service. I am fully satisfied with all designs and execution. Must visit and collaborate with their vision.”",
    author: "ALI BIN",
    title: "CEO & Founder",
    avatarLabel: "51X51",
    style: "white",
  ...
  },
  {
    id: 4,
    quote:
      "“A group of young dynamic people helping small brands to recognise across globe and cleverly position any budding brands to reach Target audience.”",
    extendedQuote:
      "“A group of young dynamic people helping small brands to recognise across globe and cleverly position any budding brands to reach Target audience. A group of young dynamic people helping small brands to recognise across globe and cleverly position any budding brands to reach Target audience. A group of young dynamic people helping small brands to recognise across globe and cleverly position any budding brands to reach Target audience.”",
    author: "TOMS DIGEST",
    title: "CEO & Founder",
    avatarLabel: "51X51",
    style: "gold",
  ...
  {
    id: 5,
    quote: "“GREAT AND AMAZING SERVICES, SATISFIED.”",
    extendedQuote:
      "“GREAT AND AMAZING SERVICES, SATISFIED. They delivered beyond our expectations with super fast turnarounds and incredible visual finesse.”",
    author: "Ranjan Baul",
    title: "CEO & Founder",
    avatarLabel: "51X51",
    style: "dark",
  ...
  },
  {
    id: 6,
    quote:
      "“Working with Contenaissance transformed our digital identity. The attention to detail and motion craft is unmatched in the industry.”",
    extendedQuote:
      "“Working with Contenaissance transformed our digital identity. The attention to detail and motion craft is unmatched in the industry. Highly recommended for visionary projects.”",
    author: "Elena Rostova",
    title: "Head of Brand, Synthetix",
    avatarLabel: "51X51",
    style: "white",
    tilt: 2,
  },
  {
    id: 7,
    quote:
      "“Exceeded every expectation we had for our rebranding campaign. High efficiency and stellar execution from day one.”",
    extendedQuote:
      "“Exceeded every expectation we had for our rebranding campaign. High efficiency and stellar execution from day one.”",
    author: "Marcus Vance",
    title: "Founder, Nova Creative",
    avatarLabel: "150×150",
    style: "dark",
    tilt: 8,
  },
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#fafafa] py-16 md:py-24 text-zinc-900 select-none">
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(#c5c5c5 1.5px, transparent 1.5px)`,
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center px-4 text-center">
        ...
        <motion.h2
          ...
          className="font-sans text-4xl font-extrabold tracking-tight text-black sm:text-5xl md:text-6xl uppercase"
        >
          CLIENT REVIEWS
        </motion.h2>
            ...
            return (
              ...
              >
                ...
                <div className="relative min-h-[140px] sm:min-h-[160px] md:min-h-[180px] flex flex-col justify-between">
                  <p
                    className={`font-sans text-sm sm:text-base leading-relaxed tracking-normal transition-all duration-300 line-clamp-10`}
                  >
